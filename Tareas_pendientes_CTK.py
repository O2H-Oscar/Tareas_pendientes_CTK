...
entrada_texto=ctk.CTkTextbox(frame_superior,width=560,height=90,corner_radius=5,font=("Arial",14))  # Crear un cuadro de texto con un tamaño específico y fuente Arial de tamaño 14 y negrita
entrada_texto.pack(side="top",pady=(25,10))                                                # Empaquetar el cuadro de texto en la parte superior con un margen de 5 píxeles
...
style.configure("Treeview.Heading",font=('Arial',12,'bold'),relief='raised',background='blue') # Configura el estilo de las cabeceras de las columnas del Treeview
style.map("Treeview",background=[("selected","sky blue")])  # Color de fondo al seleccionar una fila

# Definiendo Treeview
tree = ttk.Treeview(frame_inferior,columns=("NOTA","FECHA"),show="tree headings",style="Treeview")

# Definir encabezados
tree.heading("#0",text="Estado",anchor="center")
tree.heading("NOTA",text="Tarea",anchor="center")
tree.heading("FECHA",text="Fecha",anchor="center")

# Configuración de las columnas
tree.column("#0",width=2,anchor="center")
tree.column("NOTA",width=300,anchor="center")
